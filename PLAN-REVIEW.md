...
- RUNNING: P3 publish hardening, `/api/publish` progress over SSE, the publish and claim dialog states, the check fallback when an old dev server is running (branch `p3-publish`). Then P2, P6 and P4 in parallel, then E2E run 3 and the gate.
