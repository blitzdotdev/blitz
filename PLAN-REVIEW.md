...
- RUNNING: `plugin-host`: import map and dev server map every `kite3d.plugins` package by bare name and subpath; publish ships plugin package files; fixture plugin tests; guide paragraph "Plugins"; real proof with the MuJoCo tarball. Ships in 0.14.0 with the layout pass.
