...
| Domain cutover: `blitz.dev` to the backend and store, `*.app.blitz.dev` to the gateway | DONE | product traffic uses the custom domains; the workers.dev routes remain available for compatibility |
