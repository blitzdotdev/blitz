...
- DECIDED (owner, Option A): Check becomes an icon button right of Open game with a pass or fail dot and a hover popover of the three outcomes; Checkpoint and Restore last checkpoint become Save Scene menu items; the centered toolbar group goes away. Fix pass M (`fix-m`) is RUNNING.
