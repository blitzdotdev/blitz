...
- RUNNING: fix pass I for I1 to I11, the H6 residual, and the documentation gaps (`fix-i`); the E2E gate execution (started before the cutover; host-mode rows rerun afterwards).
