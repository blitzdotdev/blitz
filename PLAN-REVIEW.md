...
- RUNNING: `upgrade-fix2`: the legacy migration also removes or bumps direct `@blitzdev/engine|editor|template` pins (tarball-era projects on this machine pin all four), so `kite3d doctor` passes after `kite3d upgrade`; ships as 0.13.2.
