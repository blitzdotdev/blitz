...
- RUNNING: `plugin-tests`: the four plugin tests installed `kite3d@0.14.0` from the registry, which does not exist before the release; they become registry-free; the assets.json drop test is hardened. Main is not pushed until this lands.
