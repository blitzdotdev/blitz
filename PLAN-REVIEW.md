...
- RUNNING: the run 4 session review, and the E2E gate execution from `docs/e2e-test-plan.md` on the test domains (host-mode rows skipped until the staging wildcard exists).
