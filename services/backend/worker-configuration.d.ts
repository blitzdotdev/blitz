/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f9e6c7e39c9a98ca1fbd43dab1583851)
// Runtime types generated with workerd@1.20260908.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	ANON_TRIPWIRE: KVNamespace;
	BLOBS: R2Bucket;
	DB: D1Database;
	ANON_RL_IP: RateLimit;
	ANON_RL_ASN: RateLimit;
	APP_DOMAIN: "app.blitz.dev";
	GATEWAY_ORIGIN: "https://blitz-game-gateway.blitzapp.workers.dev";
	MAX_BLOB_BYTES: "104857600";
	MAX_GAME_BYTES: "524288000";
	ANON_TTL_HOURS: "12";
	RELEASE_RETENTION: "10";
	BLOB_GRACE_SECONDS: "86400";
	RECONCILE_BATCH: "500";
	REQUIRE_REGISTERED_RUNTIME: "false";
	GOOGLE_CLIENT_ID: "118090436804-rqddo4q5qof92bejmslrrtglnrtb23k1.apps.googleusercontent.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_DOMAIN" | "GATEWAY_ORIGIN" | "MAX_BLOB_BYTES" | "MAX_GAME_BYTES" | "ANON_TTL_HOURS" | "RELEASE_RETENTION" | "BLOB_GRACE_SECONDS" | "RECONCILE_BATCH" | "REQUIRE_REGISTERED_RUNTIME" | "GOOGLE_CLIENT_ID" | "RESPOND_WITH_ERRORS" | "RESPOND_WITH_QUERY_LOG">> {}
}
declare module "*.md" {
	const value: string;
