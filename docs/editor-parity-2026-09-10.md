...
|---|---|
| `src/adapters/BlitzToolbarControls.tsx` | Save Scene backing, the theme hook, and semantic test compatibility. |
...
| `src/utils/ViewerInstanceManager.ts` | Dev-server loading, persistence, play mode, imports, and asset registration behind reference component props. |
