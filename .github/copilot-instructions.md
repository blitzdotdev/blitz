...
- In this project, we are building Kite 3D - An advanced web based game engine using threepipe, three.js for rendering, entity component framework and other utility.
...
- The game developer is expected to write scripts manually or using agenetic coding tools to create full-featured game components and systems. The game editor UI includes an AI agent, but many users prefer to use local AI in their IDE like copilot, claude code etc.
...
- After doing the task, DO NOT explain all the changes in a summary or md file
