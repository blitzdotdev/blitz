...
export interface TreeNodeInfo<T = {}> {
    ...
    /**
     * Whether this node can be dragged. If false, drag events will not be enabled for this node.
     */
    draggable?: boolean;

    /**
     * Whether this node can be a drop target. If false, drop events will not be enabled for this node.
     */
    droppable?: boolean;
